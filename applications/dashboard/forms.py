...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        model = Products
        fields = ('title', 'subCategory', 'imagef', 'images', 'imaget', 'price', 'pricePromo', 'colors', 'resume', 'sizes', 'available', 'quantity', 'statusproduct', 'warranty', 'original', 'comissionPriceProd')
