...
class Products(models.Model):
	...
	promotion = models.BooleanField('Promocion', default=False, blank=True)
	available = models.BooleanField('Disponible', default=True, blank=True)
	exhausted = models.BooleanField('Agotado', default=False, blank=True)
	season = models.BooleanField('Temporada', default=False, blank=True)
	virus = models.BooleanField('Virus', default=False, blank=True)
