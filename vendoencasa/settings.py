...
ALLOWED_HOSTS = ['https://www.vendoencasa.net', 'www.vendoencasa.net']
...
AWS_ACCESS_KEY_ID = 'AKIAZF7RZHQPWXBBG6E3'
AWS_SECRET_ACCESS_KEY = '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'
AWS_STORAGE_BUCKET_NAME = 'vendoencasastoreInfo'
...
EMAIL_HOST_PASSWORD = 'wsttpjnauvlvxrhj'
EMAIL_USE_TLS = True
